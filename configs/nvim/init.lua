...
keymap("n", "<leader>fk", "<CMD>Telescope keymaps theme=ivy<CR>", opts)
-- Explore --
...
-- Lsp --
vim.api.nvim_create_user_command("LspGotoDefinitions", "Telescope lsp_definitions theme=ivy", {})
vim.api.nvim_create_user_command("LspGotoTypeDefinitions", "Telescope lsp_type_definitions theme=ivy", {})
vim.api.nvim_create_user_command("LspGotoImplementations", "Telescope lsp_implementations theme=ivy", {})
vim.api.nvim_create_user_command("LspReferences", "Telescope lsp_references theme=ivy", {})
